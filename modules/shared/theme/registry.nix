...
in
{
  ...
  high-contrast = mkTheme {
    name = "high-contrast";
    background = "#ffffff"; surface = "#f8f8f8"; overlay = "#eeeeee";
    text = "#000000"; subtext = "#333333"; muted = "#666666";
    primary = "#0066cc"; secondary = "#cc6600";
    success = "#008800"; warning = "#cc8800"; error = "#cc0000"; info = "#0066cc";
  };
  ...
  # Helper to check if theme exists
  exists = name: builtins.elem name available;
  
  # Export the constructor for custom themes
  inherit mkTheme;
}
